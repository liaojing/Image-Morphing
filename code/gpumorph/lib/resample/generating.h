...
namespace kernel {
    ...
    namespace generating {
        ...
        namespace d {
            class bspline3: public generating::cloner_base<bspline3> {
            public:
            ...
            class bspline5: public generating::cloner_base<bspline5> {
            public:
                bool normalize(void) const { return false; }
                bool primal(void) const { return false; }
            ...
            class bspline7: public generating::cloner_base<bspline7> {
            public:
                bool normalize(void) const { return false; }
                bool primal(void) const { return false; }
